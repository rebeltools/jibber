...
- (IBAction)reloadData {
    ...
    [manager GET:@"https://www.nsscreencast.com/api/episodes.json" parameters:nil success:^(NSURLSessionDataTask *task, id responseObject) {
        NSArray *array = responseObject[@"episodes"];
        dispatch_async(dispatch_get_main_queue(), ^{
            RLMRealm *realm = [RLMRealm defaultRealm];
            
            [realm beginWriteTransaction];
            [MCEpisode createOrUpdateInRealm:realm withJSONArray:array];
